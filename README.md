...
Our project coded with basic knowledge of OpenCV, Flask, HTML, CSS and Sqlite3. In this application, we deploy pretrained models on face detection and facial landmark detection, based on pretrained Caffe model and FacemarkLBF released by OpenCV.
...
```bash
$ git clone https://github.com/DuongDuc15/Face-filter.git
$ cd Face-filter
...
< PROJECT ROOT >
   ...
   |    |
   |    |-- home/ 
   |    |    |-- apply_mask.py              # Apply mask to detected faces
   |    |    |-- routes.py                  # Define app routes and perform most face detection tasks
   |    |
...
---
The website is developed and modified from an open-source 
